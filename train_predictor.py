...
print(f"Loading GPT model from {out_dir}")
...
dummy_input = torch.randint(high=model_args['vocab_size'], size=(1, gptconf.block_size * 2)).to(device)
with torch.no_grad():
